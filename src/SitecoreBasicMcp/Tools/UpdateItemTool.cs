...
[McpServerToolType]
public class UpdateItemTool(IConfiguration configuration, SitecoreAuthenticationService authenticationService) : SitecoreAuthoringToolBase(configuration, authenticationService)
{
